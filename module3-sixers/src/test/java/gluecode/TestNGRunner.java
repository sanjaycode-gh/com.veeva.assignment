...
public class TestNGRunner extends AbstractTestNGCucumberTests {
    ...
    public void setUp(@Optional("chrome") String browser , @Optional("") String cucumberTags, @Optional("testdata/SixersTestData.yml") String yamlFilePath) {
